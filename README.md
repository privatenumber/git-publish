...
| Flag                    | Description                                                   |
| ----------------------- | ------------------------------------------------------------- |
| `-b, --branch <name>`   | Target branch name. Workspace dependencies use this name as a prefix |
...
The selected package uses the requested `--branch` name. Dependencies use `<branch>-<package-name>`. Without `--branch`, each package uses `npm/<current branch or tag>-<package-name>`.
